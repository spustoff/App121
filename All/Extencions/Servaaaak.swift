    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                "andba": myData.isVpn,
                "Tuohu": myData.deviceName,
                "ZFxoN": myData.deviceModel,
                "lrAMW": myData.uniqueNumber,
                "VdsAh": myData.wifiAddress,
                "sQUHJ": myData.simCarrier,
                "xbuRw": myData.iosVersion,
                "rqAIY": myData.deviceLang,
                "sQvtr": myData.timeZone,
                "SOmaQ": myData.isCharging,
                "DwLuv": myData.capacity,
                "StwPp": isCaptured,
                "KDhsd": cast,
                "sIFfogDF": myData.apps,
                "jdOFGh": myData.chargePercent,
                "dllPTR": myData.keyboards,
                "piurDK": myData.region,
                "iDjgoaS": myData.isMetric
            ]
...
struct MyDataClass {
    ...
    static func getMyData() -> MyData {
        ...
        let myData = MyData(isVpn: isConnectedToVpn, deviceName: nameDevice, deviceModel: deviceType.rawValue, uniqueNumber: uniqNumber, wifiAddress: [wifiAdress, cellularAdress], simCarrier: arrayOfCarrier, iosVersion: systemVersion, deviceLang: locale, timeZone: localTimeZoneAbbreviation, isCharging: isCharging, capacity: memory + ", " + freeSpaceInGB + ", " + totalSpaceInGB, apps: isApps, chargePercent: Int(batteryLevel), keyboards: availableLanguages, region: "\(regionCode ?? "nil")", isMetric: isMetric)
